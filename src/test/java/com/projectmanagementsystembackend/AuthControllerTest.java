...
public class AuthControllerTest {
    ...
    void testLogin() throws Exception {
        ...
        var loginRequest = new TestRateLimit.LoginRequest("test@example.com", "password123");
        var loginRequest2 = new TestRateLimit.LoginRequest("patelyash2462@gmail.com", "password123");
